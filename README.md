...
Наша задача состоит в том, чтобы описать метод построения минимальной ДНФ, эквивалетной заданной булевой функции. Я рассмотрел алгоритм Квайна. Этот алгорит исходит обязательно из СДНФ, которая строится по таблице функции. ![](/img/СДНФ.png)
